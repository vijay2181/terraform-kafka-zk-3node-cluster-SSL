...
broker.id=2
listeners=SSL://$KAFKA3:9092
advertised.listeners=SSL://$KAFKA3:9092
...
ssl.keystore.location=/certs/$KAFKA3.keystore.jks
ssl.truststore.location=/certs/$KAFKA3.truststore.jks
